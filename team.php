...
<head>
        ...
        <title>Team- KIIT Entrepreneurship Cell</title>
        ...
        <style type="text/css">
            .show_pcr_main, .show_rnd_main, .show_tech_main, .show_design_main{
                display: none;
            }
        </style>
    </head>
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                <div class="inner-banner">
                    <h2 class="inner-banner-title">KIIT E-CELL TEAM</h2>
                </div>
            </div>
        </div>
    </div>
...
<section class="xs-section-padding">
            ...
            <div class="col-lg-12">
                <div class="filter-button-wraper">
                    <ul id="filters" class="option-set clearfix main-filter" data-option-key="filter">
                        <li><a href="#" data-option-value="*" class="selected">BODS</a></li>
                        <li><a href="#" data-option-value=".item1">ADVISORS</a></li>
                        <li><a style="cursor: pointer;" id="pcr">PCR</a></li>
                        <li><a style="cursor: pointer;" id="rnd">R&D</a></li>
                        <li><a style="cursor: pointer;" id="tech">TECH</a></li>
                        <li><a style="cursor: pointer;" id="design">DESIGN</a></li>
                    </ul>
                </div><!-- .filter-button-wraper END -->
            </div>
        </div><!-- .row end -->

        <div class="manually_add">
 ...
 <div class ="show_rnd_main">
        <div class="cases-grid" id="show_rnd">

        </div>
    </div>


     <div class ="show_tech_main">
        <div class="cases-grid" id="show_tech">

        </div>
    </div>


     <div class ="show_design_main">
        <div class="cases-grid" id="show_design">
...
</section><!-- agency portfolio grid section end -->
...
//         });
    ...
    $('#pcr').click(function(){        
          $('.manually_add').fadeOut();
          $('.show_rnd_main').fadeOut();
          $('.show_tech_main').fadeOut();
          $('.show_pcr_main').fadeIn();
          $('.show_design_main').fadeOut();

        });

     $('#rnd').click(function(){        
          $('.manually_add').fadeOut();
          $('.show_pcr_main').fadeOut();
          $('.show_tech_main').fadeOut();
          $('.show_rnd_main').fadeIn();
          $('.show_design_main').fadeOut();
